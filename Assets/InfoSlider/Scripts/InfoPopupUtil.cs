...
namespace Madhur.InfoPopup
{
	public class InfoPopupUtil : MonoBehaviour
	{
		...
		public static void ShowInformation ( string a_Message ,Sprite img)
		{
			Setup ( );
			m_infoHandler.ShowPopUp ( a_Message , _instance.InfoPopup ,img);
		...
		{
			Setup ( );
			m_infoHandler.ShowPopUp ( a_Message , _instance.WarningPopup ,null);
		...
		{
			Setup ( );
			m_infoHandler.ShowPopUp ( a_Message , _instance.AlertPopup ,null);
